-- This file consolidates all schema bug fixes.
-- Individual numbered migrations (004-007) contain the same fixes for focused application.
-- BUG-022: Fix cancel_booking() audit INSERT using wrong column names (module, record_id instead of entity_type, entity_id)
-- See also: 004_fix_cancel_booking_columns.sql
...
-- See also: 005_fix_promo_rls_policy.sql
...
-- See also: 006_fix_get_available_seats.sql
...
-- See also: 007_fix_audit_trigger_cleanup.sql
